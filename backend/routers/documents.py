...
def update_status(
    ...
    # Синхронизация одобренного путевого листа в таблицу waybills
    if body.status == "approved" and doc.document_type == "waybill":
        try:
            import json
            extra = {}
            if doc.extra_data:
            ...
            # Проверяем, существует ли уже такой путевой лист
            ...
            print(f"Ошибка при синхронизации одобренного путевого листа: {str(e)}")
